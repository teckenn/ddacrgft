                ...
                <div id="contentbox" class="col-sm-8 text-justify">
                    <div class="searchbox">
                        ...
                        <div class="search-container">
                            <div class="col-sm-3">
                                Schedule ID:<br>
                                <input type="text" placeholder="Enter Schedule ID" name="search" id="keyword" onkeyup="searchid()">
                            </div>
                            
                            <div class="col-sm-3">
                            From:<br>
                                <input type="text" placeholder="Enter Shipping From Country" name="search" id="source" onkeyup="searchfrom()" required>
                            </div><div class="col-sm-3">
                            Destination:<br>
                            <input type="text" placeholder="Enter Shipping To Country" name="search" id="destination" onkeyup="searchto()" required>
                            </div><div class="col-sm-3">
